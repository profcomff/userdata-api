...
async def get_param_alias(
    ...
    """
    alias = _get_param_alias(param_id=param_id, alias_id=alias_id)
    return ParamAliasGet.model_validate(alias)


@param_alias.get("", response_model=list[ParamAliasGet])
async def get_param_aliases(param_id: int) -> list[ParamAliasGet]:
    """
...
async def delete_param_alias(
    ...
    """
    _ = _get_param_alias(param_id=param_id, alias_id=alias_id)
